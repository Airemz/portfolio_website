...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://formsubmit.co/s3rahman@uwaterloo.ca/', {
        method: 'POST',
        headers: {
          ...
          <div className="flex-1 min-w-[280px]">
            ...
            <div className="mt-6 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:s3rahman@uwaterloo.ca" className="hover:text-primary transition-colors">
                  s3rahman@uwaterloo.ca
                </a>
              </div>
              <div className="flex items-center gap-3">
                <FaLinkedin className="text-primary" />
                <a href="https://www.linkedin.com/in/sadiq-r" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                  linkedin.com/in/sadiq-r
                </a>
              </div>
              <div className="flex items-center gap-3">
                <FaGithub className="text-primary" />
                <a href="https://github.com/Airemz" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                  github.com/Airemz
                </a>
              </div>
            </div>
