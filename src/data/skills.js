export const skills = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Electron Builder', icon: 'https://upload.wikimedia.org/wikipedia/commons/9/91/Electron_Software_Framework_Logo.svg' },
    ],
  },
  {
    ...
    items: [
      ...
      { name: 'ARM/RTOS (STM32)', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/embeddedc/embeddedc-original.svg' },
    ],
  },
];
